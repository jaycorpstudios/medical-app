...
export default class ThemeFileInput extends React.Component {
      ...
      return (
        <div className="FileUploader">
          ...
          <div>
            ...
            <div className={classnames('FileUploader__progress-bar', { complete: !uploadInProgress })} />
          </div>
          {!uploadInProgress && <ThemeButtonDefault icon="delete_outline" noShadow onClick={this.removeFile()} />}
        </div>
      );
    }
    ...
    render() {
      const {
        icon, className, negative, value, label, hasError, errorMessage, uploadInProgress, resetValue, ...other
      } = this.props;
