...
const createInputs = ({
  fields = {}, section, fieldsOrder, handleInputData, resetValue,
} = {}) => [...fieldsOrder.values()].map((fieldKey) => {
...
class FormGroupData extends React.Component {
  ...
  render() {
    const {
      handleInputData, resetValue, data = {}, section, title,
    } = this.props;
    ...
    return (
      <>
        ...
        {createInputs({
          fields: data, section, handleInputData, resetValue, fieldsOrder,
        })}
      </>
    );
  }
